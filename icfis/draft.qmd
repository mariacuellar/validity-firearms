...
- Reproduces the real study's decision table and the examiner-to-examiner spread in inconclusive rates; does **not** capture firearm-level differences
...
::: {.notes}
~1 min. The hook is that the bounding procedure gives a range instead of one
falsely precise number, and both ends come from the same raw responses.
:::
...
On the other hand: this isn't a true "solution" to the problem of inconclusives in black-box studies
